...
class TestPDE(unittest.TestCase):
    ...
    def test_HRidge(self):
        ...
        w0exp = np.array([1.0 + 0.0j, 0.1 + 0.0j, 0.01 + 0.0j], dtype=np.complex64)
        w1exp = np.array([0.973 + 0.0j, 0.07 + 0.0j, 0.0 + 0.0j], dtype=np.complex64)
        w2exp = np.array([1.131871 + 0.0j, 0, 0], dtype=np.complex64)
